package com.streamapi.warburton.chap01;
...
public class SampleData {
  ...
  public static final Album aLoveSupreme = new Album("A Love Supreme",
      ...
      List.of(johnColtrane));

  public static final Album sampleShortAlbum = new Album("sample Short Album",
      List.of(new Track("short track", 30)),
      List.of(johnColtrane));

  public static final Album manyTrackAlbum = new Album("sample Short Album", asList(

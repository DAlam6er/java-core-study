...
public class StringExamples {
  ...
  public static void main(String[] args) {
    ...
    String string = "abc\u5639\u563b";
    byte[] utf8Arr = string.getBytes(StandardCharsets.UTF_8);

    // Преобразование массива байтов UTF-8 в текст кодировки Unicode
    string = new String(utf8Arr, StandardCharsets.UTF_8);

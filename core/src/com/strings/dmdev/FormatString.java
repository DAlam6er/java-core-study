...
/**
 * 3. Написать функцию, принимающую в качестве параметра имя, фамилию и отчество
 * и возвращающую инициалы в формате "Ф.И.О.". Учесть, что входные параметры
 * могут быть в любом регистре, а результирующая строка должна быть в верхнем
 */

...
public class Point {
   ...
   * Поэтому дистанция определяется по теореме Пифагора:
   * сумма квадратов длин катетов равна квадрату длины гипотенузы.
   * <p>
   * Следовательно необходимо просто найти расстояние между
   * соответствующими двумя точками (это будут катеты),
   * и потом просто по теореме Пифагора извлечь корень из суммы квадратов этих катетов.
   * <p>
   * Здесь нет разницы от какой точки отнимать соответствующие координаты,

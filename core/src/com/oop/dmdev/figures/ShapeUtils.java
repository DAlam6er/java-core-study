...
/**
 * Не забывать, что каждый утилитный класс
 * (это класс, что содержит исключительно static методы и поля)
 * должен быть final и иметь private constructor.
 * В современных Java приложениях используют сторонюю библиотеку Lombok,
 * чтобы не писать это вручную каждый раз
 */
